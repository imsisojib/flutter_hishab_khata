...
class OrdersRepository implements IOrdersRepository{
  ...
  Future<int?> addOrder(Order order) async{
    ...
    Debugger.debug(title: "OrdersRepository.addOrder", data: result,);
    return result;
  }

  @override
  Future<int?> deleteOrder(int orderId) async{
    int? result = await db.database?.delete(db.ordersTable, where: 'id = ?', whereArgs: [orderId]);
    Debugger.debug(title: "OrdersRepository.deleteOrder", data: result,);
    return result;
  }
  ...
  Future<List<Order>> fetchAllOrders() async{
    ...
    Debugger.debug(title: "OrdersRepository.fetchAllOrders", data: mapList,);
  ...
  Future<int?> updateOrder(Order order) async{
    int? result = await db.database?.update(db.ordersTable, order.toJson(),
        where: 'id = ?', whereArgs: [order.id]);
    Debugger.debug(title: "OrdersRepository.updateOrder", data: result,);
    return result;
  }
