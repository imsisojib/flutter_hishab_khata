...
class RouterHelper {
  ...
  void setupRouter() {
    ...
    router.define(Routes.customerCreateScreen, handler: _customersCreateScreenHandler, transitionType: TransitionType.fadeIn);
    router.define(Routes.customerUpdateScreen, handler: _customersUpdateScreenHandler, transitionType: TransitionType.fadeIn);
  }
